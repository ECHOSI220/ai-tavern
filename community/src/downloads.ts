...
export async function downloadsPage(target:Element){
 ...
 }).join('')}</div><section class="panel"><h2>更新说明 / What's new</h2><p>${escape(release.notes)}</p><p>不会要求你上传 AI API 密钥。已有本地存档建议先备份，再覆盖安装。 / Your AI API key is never requested here. Back up local saves before upgrading.</p><p><a class="button" href="${escape(sourceUrl)}" target="_blank" rel="noopener">查看网页开源代码 / View open-source web code ↗</a></p></section>`;
}
